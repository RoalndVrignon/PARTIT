...
<section class="home">
    ...
    <div class="container-fluid">
        ...
        <div id="go" class="button text-center" style="margin-top: 100px">
            <a href="login.php"<button type="button"class="btn btn-lg btn-primary" > Se connecter</button></a>
            <a href="register.php"><button type="button"class="btn btn-lg btn-primary"> S'inscrire</button></a>
